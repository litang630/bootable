...
#define LCM_ID_HE080IA06B									0x59

#define GPIO_LCM_RST	(GPIO28 | 0x80000000)
#define GPIO_LCD_V18_EN     (GPIO29 | 0x80000000)
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    //improve clk quality
    params->dsi.PLL_CLOCK = 267; //this value must be in MTK suggested table
...
static void lcm_init(void)
{
    ...
    printf("%s,HE080IA06B_P80_lcm_drv LK \n", __func__);
#else
    printk("%s,HE080IA06B_P80_lcm_drv kernel", __func__);
#endif
		lcd_reset(1);
		MDELAY(10);
		lcd_reset(0);
...
static unsigned int lcm_compare_id(void)
{
	...
	#ifdef BUILD_LK
		printf("%s, LK HE080IA06B debug: HE080IA06B \n", __func__);
    #else
		printk("%s, kernel HE080IA06B debug: HE080IA06B \n", __func__);
    #endif
	lcd_reset(1);
	MDELAY(10);
	lcd_reset(0);
    ...
    #ifdef BUILD_LK
		printf("%s, LK HE080IA06B debug: HE080IA06B id = 0x%08x\n", __func__, id);
    #else
		printk("%s, kernel HE080IA06B debug: HE080IA06B id = 0x%08x\n", __func__, id);
    #endif

    if(id == LCM_ID_HE080IA06B)
    	return 1;
    else
        return 0;
...
static void lcm_init_power(void)
{
		...
		MDELAY(20);
		//VGP3-3.3V
	    mt6325_upmu_set_rg_vgp3_vosel(0x7);
	    mt6325_upmu_set_rg_vgp3_en(0x1);
...
static void lcm_suspend_power(void)
{
		...
		MDELAY(50);
		//VGP3-3.3V
	    mt6325_upmu_set_rg_vgp3_vosel(0x0);
	    mt6325_upmu_set_rg_vgp3_en(0x0);	
#else
...
LCM_DRIVER HE080IA06B_P80_lcm_drv =
{
        .name           	= "HE080IA06B",
