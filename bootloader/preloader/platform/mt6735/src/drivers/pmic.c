...
#define PMIC_TYPE_DETECTION //wisky-lxh@20150929,fix charging logo show too slowly
...
void pmic_6328_efuse_management(void)
{
	...
	if ((efuse_data[0x11] & 0x1) == 0)
	{
		...
		//print("[pmic_6328_efuse_management]4.27 data32:0x%x ovp_trim[0x%x]:0x%x data32_chk:0x%x\r\n", data32, MT6328_PMIC_RG_OVP_TRIM_ADDR, mt6328_ovp_trim[data32], data32_chk);
	}
	//else
