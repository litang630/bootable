    ...
    if (rank_nr == 1) {
		...
		*((V_UINT32P)(DDRPHY_BASE + 0xf4)) = *((V_UINT32P)(DDRPHY_BASE + 0xf4)) & ~(0x1 << 15);
	    ...
	    if (((rank0_coarse <= 24) && (rank1_coarse <= 24))) {
	        print("D3T DFS could be enable\n");
	        *((V_UINT32P)(DRAMC0_BASE + 0xf4)) = *((V_UINT32P)(DRAMC0_BASE + 0xf4)) | (0x1 << 15);
	        *((V_UINT32P)(DDRPHY_BASE + 0xf4)) = *((V_UINT32P)(DDRPHY_BASE + 0xf4)) | (0x1 << 15);
	        return 1;
            } else {
		print("D3T DFS could not be enable\n");
		*((V_UINT32P)(DRAMC0_BASE + 0xf4)) = *((V_UINT32P)(DRAMC0_BASE + 0xf4)) & ~(0x1 << 15);
		*((V_UINT32P)(DDRPHY_BASE + 0xf4)) = *((V_UINT32P)(DDRPHY_BASE + 0xf4)) & ~(0x1 << 15);
		return 0;
            }
	    ...
	    if (((rank0_coarse == 25) && (rank1_coarse == 25) && (rank0_fine >= 56) && (rank1_fine >= 56)) \
	        ...
	        print("D3 DFS could be enable\n");
	        *((V_UINT32P)(DRAMC0_BASE + 0xf4)) = *((V_UINT32P)(DRAMC0_BASE + 0xf4)) | (0x1 << 15);
	        *((V_UINT32P)(DDRPHY_BASE + 0xf4)) = *((V_UINT32P)(DDRPHY_BASE + 0xf4)) | (0x1 << 15);
	        return 1;
            } else {
		print("D3 DFS could not be enable\n");
		*((V_UINT32P)(DRAMC0_BASE + 0xf4)) = *((V_UINT32P)(DRAMC0_BASE + 0xf4)) & ~(0x1 << 15);
		*((V_UINT32P)(DDRPHY_BASE + 0xf4)) = *((V_UINT32P)(DDRPHY_BASE + 0xf4)) & ~(0x1 << 15);
		return 0;
            }
...
void restore_DDR_regs(void)
{
      ...
      if((g_ddr_reserve_enable==1) && (g_ddr_reserve_success==1)) {
          print("[DDR Reserved Mode] mempll calib for 2/3-PLL\n");
          mt_mempll_cali();
      }
#endif
}
...
#if defined(MACH_TYPE_MT6735) || defined(MACH_TYPE_MT6735M) || defined(MACH_TYPE_MT6753)
#ifdef ENABLE_DFS
